...
<a id="ctxapicaptureevidence--apicaptureevidence"></a>

### `ctx.apiCaptureEvidence` — `ApiCaptureEvidence`

Immutable evidence package storage and loopback HTTP provider.

Source: [`packages/host/api-capture-evidence/src/index.ts:260`](../../packages/host/api-capture-evidence/src/index.ts)
