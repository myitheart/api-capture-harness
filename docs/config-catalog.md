...
Source: [`packages/client/api-capture-draft/src/index.ts:12`](../packages/client/api-capture-draft/src/index.ts)
...
Source: [`packages/host/api-capture-evidence/src/index.ts:67`](../packages/host/api-capture-evidence/src/index.ts)
