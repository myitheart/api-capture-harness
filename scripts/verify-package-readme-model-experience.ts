...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/api-capture-draft': { kind: 'indirect', reason: 'The bridge only fills the native composer; the user decides whether and when that Prompt enters model history.' },
  ...
  'packages/host/api-capture-evidence': { kind: 'indirect', reason: 'The storage service adds no model context; a user-submitted Prompt may reference a finalized package path.' },
